...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '和知,', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '我就是我，颜色不一样的烟火🎆', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kris-notion-jet.vercel.app/', // 网站地址
